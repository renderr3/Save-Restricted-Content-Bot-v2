   ...
   if update_channel:
      try:
         ...
         if user.status == "kicked":
            await message.reply_text("You are Banned. Contact -- @Aspiranthelper836")
            return 1
        ...
        return 1
         ...
         await message.reply_text("Something Went Wrong. Contact us @Aspiranthelper836...")
         return 1
